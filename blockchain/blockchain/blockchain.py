...
def new_transaction():
    ...
    transaction_result = blockchain.submit_transaction(values['sender_address'], values['recipient_address'], values['value'], values['signature'])
    print("iii")
